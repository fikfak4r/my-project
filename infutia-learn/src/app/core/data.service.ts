...
export class DataService {
  readonly authors: Author[] = [
    { id: 'a1', name: 'Zara Okafor', handle: 'zara.builds', role: 'Product & Growth Author', bio: 'Ex-Series-A PM turned full-time writer. Zara helps builders ship products people obsess over.', avatarFrom: '#7c5cff', avatarTo: '#ff6ec7', initials: 'ZO', followers: 18400, products: 6, rating: 4.9, verified: true, location: 'Lagos, NG' },
    { id: 'a2', name: 'Daniel Mensah', handle: 'dan.writes', role: 'Finance Educator', bio: 'Making personal finance feel like a good novel, one chapter at a time.', avatarFrom: '#ffb347', avatarTo: '#ff7846', initials: 'DM', followers: 12100, products: 4, rating: 4.8, verified: true, location: 'Accra, GH' },
    { id: 'a3', name: 'Ifeoma Eze', handle: 'ifeoma.designs', role: 'Design Storyteller', bio: 'UI/UX essays, playbooks and templates for designers who ship.', avatarFrom: '#2dd4bf', avatarTo: '#3b82f6', initials: 'IE', followers: 9800, products: 5, rating: 4.9, verified: false, location: 'Abuja, NG' },
    { id: 'a4', name: 'Kunle Adeyemi', handle: 'kunle.code', role: 'Engineering Mentor', bio: 'Backend patterns explained like bedtime stories.', avatarFrom: '#f472b6', avatarTo: '#a78bfa', initials: 'KA', followers: 7300, products: 3, rating: 4.7, verified: true, location: 'Remote' },
  ];

  readonly products: Product[] = [
    { id: 'p1', slug: 'writers-edge', title: "The Writer's Edge", subtitle: 'Turn what you know into digital products that sell', authorId: 'a1', format: 'ebook', category: 'Business', price: 5000, rating: 4.9, readers: 12840, chapters: 12, coverFrom: '#7c5cff', coverTo: '#ff6ec7', icon: 'bi-book-half', excerpt: 'A field guide to packaging your knowledge into premium reading experiences.', tags: ['writing', 'monetization'], trending: true },
    { id: 'p2', slug: 'designing-for-devotion', title: 'Designing For Devotion', subtitle: 'Product craft for obsessive users', authorId: 'a3', format: 'course', category: 'Design', price: 10000, rating: 4.8, readers: 8210, chapters: 9, coverFrom: '#2dd4bf', coverTo: '#3b82f6', icon: 'bi-pencil-ruler', excerpt: 'Retention is a design problem. Learn the loops that keep users hooked.', tags: ['product', 'ux'], new: true, trending: true },
    { id: 'p3', slug: 'money-in-motion', title: 'Money In Motion', subtitle: 'Personal finance, beautifully explained', authorId: 'a2', format: 'ebook', category: 'Finance', price: 3500, rating: 4.7, readers: 15300, chapters: 15, coverFrom: '#ffb347', coverTo: '#ff7846', icon: 'bi-cash-stack', excerpt: 'Budgets, side income and investing — told like a story you cannot put down.', tags: ['finance', 'wealth'] },
    { id: 'p4', slug: 'backend-bedtime', title: 'Backend Patterns After Dark', subtitle: 'Scalable systems explained simply', authorId: 'a4', format: 'guide', category: 'Tech', price: 7500, rating: 4.8, readers: 6420, chapters: 10, coverFrom: '#f472b6', coverTo: '#a78bfa', icon: 'bi-hdd-network', excerpt: 'Queues, caches and idempotency — with diagrams rendered live as you read.', tags: ['engineering'], new: true },
    { id: 'p5', slug: 'creator-launch-kit', title: 'The Creator Launch Kit', subtitle: '60 templates for your first launch', authorId: 'a1', format: 'template', category: 'Business', price: 0, rating: 4.6, readers: 21000, chapters: 8, coverFrom: '#34d399', coverTo: '#10b981', icon: 'bi-rocket-takeoff', excerpt: 'Free forever. Copy, tweak, publish. Your knowledge, delivered.', tags: ['templates', 'launch'], trending: true },
    { id: 'p6', slug: 'deep-work-daily', title: 'Deep Work, Daily', subtitle: 'An audiobook for focused makers', authorId: 'a2', format: 'audiobook', category: 'Self', price: 4500, rating: 4.9, readers: 9870, chapters: 7, coverFrom: '#60a5fa', coverTo: '#818cf8', icon: 'bi-headphones', excerpt: 'Ten-minute listening rituals that rebuild your attention span.', tags: ['focus', 'audio'], new: true },
  ];

  readonly testimonials: Testimonial[] = [
    { quote: 'I converted two old PDFs into Infutia products in an afternoon. Sales doubled because reading here feels premium.', name: 'Chidinma R.', role: 'Author · Business', initials: 'CR', color: '#7c5cff' },
    { quote: 'Bookmarks, highlights, night mode — I finished more books last month than in the previous year.', name: 'Tobi A.', role: 'Reader · Lagos', initials: 'TA', color: '#2dd4bf' },
    { quote: 'No website. No hosting bills. No pirated PDFs floating around Telegram. Just write and publish.', name: 'Selina K.', role: 'Author · Design', initials: 'SK', color: '#ff7846' },
    { quote: 'My followers get pinged the moment I publish. The community tab turned readers into regulars.', name: 'Emeka N.', role: 'Author · Tech', initials: 'EN', color: '#f472b6' },
  ];
